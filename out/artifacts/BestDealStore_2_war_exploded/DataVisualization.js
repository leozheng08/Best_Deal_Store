...
$(document).ready(function () {
    $("#btnGetChartData").click(function () {
        ...
        $.ajax({
            ...
            type: "GET",
            dataType: "jsonp",
            //header: "{Authorization:Bearer ezIaSLXTnbRcchoMfavWm7kDaB5NvI9WcVG5okAhv-iQ-ubupwcxF-YQoyQG01wGuQMmKuBgdC-ro6Kt8CAWBk4T8maDLEHWXm1cMur9N0t3I4sNEQIw6IYonke3XXYx}",
            success: function (msg) {
                console.log(msg);
            },
            error: function () {
