...
public class ProductRecommenderUtility {
    ...
    public HashMap<String,String> readOutputFile(){
        ...
        try {
            ...
            br = new BufferedReader(new FileReader(new File("/Users/zhengleo/Desktop/CS584web/Tutorial_7/output.csv")));
    ...
    public static Product getProduct(String product){
        ...
        try
        {
            ...
            while(rs.next())
            {
                prodObj = new Product(rs.getString("Id"),rs.getString("productImage"),rs.getString("productName"),rs.getDouble("productPrice"),rs.getString("productManufacturer"),rs.getString("productCondition"),rs.getDouble("productDiscount"),rs.getDouble("ManufacturerRebate"),rs.getString("ProductType"));
            }
            rs.close();
            pst.close();
            conn.close();
