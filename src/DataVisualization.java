...
public class DataVisualization extends HttpServlet {
    ...
    private ArrayList<Review> getTop3InEveryCity(ArrayList<Review> reviewList) {
    ...
    private void displayPage(HttpServletRequest request, HttpServletResponse response, PrintWriter pw) throws IOException {
        Utilities utility = new Utilities(request, pw);
        utility.printHtml("header.html");
        pw.print("<img class=\"header-image\" src=\"images/image.jpg\" alt=\"Buildings\" />\n<div id=\"body\">\n    <section id=\"content\">\n\n        \t    <article>");
        pw.print("<h2>");
        pw.print("Best Products</h2>");
